    ...
    for _ in range(episodes):
        ...
        while True:
            ...
            for agent_id, agent_pos in agents.agent_pos.items():
                ...
                print('step=%s,reward=%.2f, new_q_val=%.2f, state=%i, action=%s' % (env.step_count, reward[agent_id], new_q_val, states[agent_id], actions[agent_id]))
                q_table[states[agent_id], temp_action] = new_q_val
